...
$.get("http://pes.eastus.cloudapp.azure.com:8000/sem/courses?USN="+USN,function(response){
...
function getMarks(){
  ...
  $.get("http://pes.eastus.cloudapp.azure.com:5000/PES/course/"+cid+"/policy?USN="+USN,function(resp){
